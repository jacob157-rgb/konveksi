            ...
            <div
                ...
                @foreach ($cuttingAmbil as $row)
                    ...
                    <div
                        ...
                        <span class="ms-4 border rounded">
                            <div class="inline-block hs-tooltip">
                                <form action="/karyawan/cutting/ambil/delete/{{ $row->id }}" method="post"
                    ...
                    @foreach ($cutingModel as $item)
                        ...
                        @endphp
                        <ul class="container mx-auto divide-y divide-gray-400 divide-dotted" style="font-family: ">
                            <div
                                class="flex m-2 items-center truncate overflow-x-auto justify-center p-2 text-xs font-semibold text-orange-800 bg-orange-100 rounded-lg w-fit justify-self-center whitespace-nowrap">
                                Model : {{ $item?->model }}
                                <span class="ms-4 border rounded">
                                    <div class="inline-block hs-tooltip">
                                        <form action="/karyawan/cutting/ambil/model/delete/{{ $item->id }}"
                                                        ...
                                                        <td colspan="2">
                                                            <div class="flex items-center justify-center py-2">
                                                                ...
                                                                <div class="inline-block hs-tooltip ms-2">
                                                                    <form
                                                                        action="/karyawan/cutting/ambil/warna/delete/{{ $rowItem->id }}"
