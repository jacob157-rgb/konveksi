                                    ...
                                    @foreach ($supplyer as $row)
                                        <tr class="text-center">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4 text-sm font-medium">
                                                ...
                                                <form action="/supplyer/delete/{{ $row->id }}" method="post" class="inline-flex">
                                                    @csrf
                                                    <button type="submit"
        ...
        <div
            ...
            <div
                ...
                <form action="/supplyer/update" method="post">
                    ...
                    <div class="overflow-y-auto p-4">
                        <label for="nama_supplyer" class="mb-2 block text-sm font-medium dark:text-white">Nama</label>
