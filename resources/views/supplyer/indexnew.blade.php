...
@section('content')
                                    ...
                                    @foreach ($supplyer as $row)
                                        <tr class="text-center">
                                            <td
                                                ...
                                                {{ $loop->iteration }}.</td>
                                            <td class="px-3 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                                {{ $row->nama }}</td>
                                            <td class="px-3 py-4 space-x-1 text-sm font-medium whitespace-nowrap">
                                                <button type="button" data-hs-overlay="#tambah-barang"
                                                    ...
                                                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-full gap-x-2 hover:bg-blue-700 focus:bg-blue-700 focus:outline-none disabled:pointer-events-none disabled:opacity-50">
                                                    Tambah
                                                    Barang Mentah
                                                ...
                                                <button data-hs-overlay="#kirim-barang"
                                                    data-supplyer-id="{{ $row->id }}" type="button"
                                                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-full gap-x-2 hover:bg-blue-700 focus:bg-blue-700 focus:outline-none disabled:pointer-events-none disabled:opacity-50">
                                                    Kirim
                                                    Barang Jadi
                                                    <svg class="size-4 shrink-0" xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <button href="/supplyer/detail/{{ $row->id }}" type="button"
        ...
        <div
            ...
            <div
                ...
                <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                    ...
                    <button type="button"
                        class="flex items-center justify-center text-sm font-semibold text-gray-800 border-transparent rounded-full bo rder size-7 hover:bg-gray-100 disabled:pointer-events-none disabled:opacity-50 dark:text-white dark:hover:bg-neutral-700"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const tambahBarangButtons = document.querySelectorAll('[data-hs-overlay="#tambah-barang"]');
            const kirimBarangButtons = document.querySelectorAll('[data-hs-overlay="#kirim-barang"]');

            tambahBarangButtons.forEach(button => {
                button.addEventListener('click', function() {
                    const supplyerId = this.getAttribute('data-supplyer-id');
                    const hiddenInput = document.querySelector('input[name="supplyer_id"]');
