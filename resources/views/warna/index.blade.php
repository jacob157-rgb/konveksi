...
@section('content')
                                    ...
                                    @foreach ($warna as $row)
                                        <tr class="text-center">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4 text-sm font-medium">
                                                ...
                                                <form action="/warna/delete/{{ $row->id }}" method="post" class="inline-flex">
                                                    @csrf
                                                    <button type="submit"
                ...
                <form action="/warna" method="post">
                    ...
                    <div class="overflow-y-auto p-4">
                        ...
                        <input type="text" id="nama" name="nama"
                            ...
                            placeholder="Masukan Jenis warna" autofocus="">
                    </div>
    ...
    <div id="edit-modal"
        ...
        <div
            ...
            <div
                ...
                <form action="/warna/update" method="post">
                    @csrf
                    <input type="hidden" name="id" id="id_warna">
                    <div class="overflow-y-auto p-4">
                        <label for="nama_warna" class="mb-2 block text-sm font-medium dark:text-white">Nama</label>
                        <input type="text" id="nama_warna" name="nama"
                            class="block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500"
                            placeholder="Masukan Jenis warna" autofocus="">
                    </div>
                    <div class="flex items-center justify-end gap-x-2 border-t px-4 py-3 dark:border-neutral-700">
    ...
    <script>
        $(document).on('click', '.edit', function(e) {
            ...
            $.ajax({
                url: `/warna/edit/${warna_id}`,
                type: "GET",
                success: function(response) {
                    $('#id_warna').val(response.data.id);
                    $('#nama_warna').val(response.data.nama);
