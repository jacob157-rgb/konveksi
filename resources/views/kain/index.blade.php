...
@section('content')
                                    ...
                                    @foreach ($kain as $row)
                                        <tr class="text-center">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4 text-sm font-medium">
                                                ...
                                                <form action="/kain/delete/{{ $row->id }}" method="post" class="inline-flex">
                                                    @csrf
                                                    <button type="submit"
                ...
                <form action="/kain" method="post">
                    ...
                    <div class="overflow-y-auto p-4">
                        ...
                        <input type="text" id="nama" name="nama"
                            ...
                            placeholder="Masukan Jenis Kain" autofocus="">
                    </div>
    ...
    <div id="edit-modal"
        ...
        <div
            ...
            <div
                ...
                <form action="/kain/update" method="post">
                    @csrf
                    <input type="hidden" name="id" id="id_kain">
                    <div class="overflow-y-auto p-4">
                        <label for="nama_kain" class="mb-2 block text-sm font-medium dark:text-white">Nama</label>
                        <input type="text" id="nama_kain" name="nama"
                            class="block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500"
                            placeholder="Masukan Jenis Kain" autofocus="">
                    </div>
                    <div class="flex items-center justify-end gap-x-2 border-t px-4 py-3 dark:border-neutral-700">
    ...
    <script>
        $(document).on('click', '.edit', function(e) {
            let kain_id = $(this).data('id');
            $.ajax({
                url: `/kain/edit/${kain_id}`,
                type: "GET",
                success: function(response) {
                    $('#id_kain').val(response.data.id);
                    $('#nama_kain').val(response.data.nama);
