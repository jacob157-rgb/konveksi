                                    ...
                                    <div class="mt-2 space-y-3">
                                        ...
                                        <div class="relative border rounded-md">
                                            <input type="number" name="jumlah_kembali" type="number" required
                                                ...
                                                class="block w-full px-4 py-3 text-sm border-gray-200 rounded-lg shadow-sm pe-16 focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            <div
                                                class="absolute inset-y-0 z-20 flex items-center pointer-events-none end-0 pe-4">
                                                <span
                                                    class="font-bold text-red-500 dark:text-neutral-500">{{ $jahit->satuan }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-2 space-y-3">
                                        ...
                                        <div class="relative border rounded-md">
                                            <input type="text" id="harga" name="bayar_ongkos"
                                                value="{{ $jahit?->bayar_ongkos }}" required
