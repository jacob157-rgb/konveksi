...
@section('content')
            ...
            <div class="-m-1.5 overflow-x-auto">
                <div class="inline-block min-w-full p-1.5 align-middle">
                    <div class="p-4 bg-white shadow rounded-xl sm:p-7 dark:bg-neutral-900">
                        <div class="mb-8 ">
                            <h2 class="text-xl font-bold text-gray-800 md:text-xl dark:text-neutral-200">
                                Pembagian Bahan Cutting ke Proses Cutting
                                <button type="button"
                        ...
                        <form action="/cutting" method="POST">
                            ...
                            <div
                                ...
                                <div class="mt-2 space-y-3">
                                    ...
                                    <input id="af-payment-billing-contact" name="jumlah_mentah" type="text"
                                        class="block w-full px-3 py-2 text-sm font-semibold border border-gray-200 rounded-lg shadow-sm pe-11 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                                ...
                                <div class="mt-2 space-y-3">
                                    ...
                                    <input id="af-payment-billing-contact" type="number" name="jumlah_ambil"
                                        class="block w-full px-3 py-2 text-sm border border-gray-200 rounded-lg shadow-sm pe-11 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                            ...
                            <div class="flex justify-start gap-x-2">
                                <button id="bon" type="button"
                                    class="inline-flex items-center px-3 py-2 text-sm font-semibold text-white bg-red-600 border border-transparent rounded-lg gap-x-2 hover:bg-red-700 disabled:opacity-50 disabled:pointer-events-none">
                                    Apakah ada BON ? ya ..
                                </button>
                            </div>
                            <div id="nominal-bon" class="hidden py-6 first:pt-0 last:pb-0 first:border-transparent">
                                <div class="mt-2 space-y-3">
                                    <p>Nominal BON</p>
                                    <div class="relative border rounded-md">
                            ...
                            <div class="flex justify-end mt-5 gap-x-2">
                                <button type="button"
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-800 bg-white border-gray-200 rounded-lg shadow-sm gap-x-2 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800">
                                    Cancel
                                </button>
                                <button type="submit"
                                    class="inline-flex items-center px-3 py-2 text-sm font-semibold text-white bg-blue-600 border border-transparent rounded-lg gap-x-2 hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
    ...
    <div id="hs-large-modal"
        ...
        <div
            ...
            <div
                class="flex flex-col bg-white border shadow-sm pointer-events-auto rounded-xl dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
