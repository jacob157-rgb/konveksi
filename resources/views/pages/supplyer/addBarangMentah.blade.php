    ...
    <div class=" bg-white shadow-sm border rounded-lg start-0 top-0 z-[80]  overflow-y-auto overflow-x-hidden">
        <form action="/barang/mentah" method="post" id="addBarangMentahForm">
            ...
            <div class="p-4 -mt-2 space-y-2 overflow-y-auto">
                <input type="hidden" class="supplyer_id" name="supplyer_id" value="{{ $supplayer->id }}">
                <input type="hidden" class="unique_id" name="unique_id" value="{{ $barangMentahFirst->unique_id }}">
                ...
                <div class="value-container">
                    ...
                    <label for="harga" class="block mb-2 text-sm font-medium dark:text-white">Harga
                        Barang</label>
                    ...
                    <label for="total" class="block mb-2 text-sm font-medium dark:text-white">Total
                        Harga</label>
                    <div class="relative rounded-md">
            ...
            <div class="flex items-center justify-end px-4 py-3 border-t gap-x-2 dark:border-neutral-700">
                <a href="/supplyer/detail/{{ $supplayer->id }}"
