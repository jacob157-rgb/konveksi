    ...
    <div class="flex flex-col">
        <div class="flex items-center justify-between pb-2 mb-2 border-b">
            @if ($operational->isNotEmpty())
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-neutral-200">Daftar Pengeluaran Operational</h2>
                <button data-hs-overlay="#modal-tambah"
                    ...
                    Tambahkan Pengeluaran Operational
                </button>
            @else
                    ...
                    @if ($operational->isEmpty())
                        <div class="mx-auto flex min-h-[400px] w-full max-w-sm flex-col justify-center px-6 py-4">
                            ...
                            <h2 class="mt-5 font-semibold text-gray-800 dark:text-white">
                                Belum ada Pengeluaran Operational
                            </h2>
                            <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                                Silahkan tambah Saldo Awal terlebih dahulu.
                            </p>
                                ...
                                @foreach ($operational as $row)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            {{ formatRupiah($row->saldo_awal) }}</td>
                                        <td
                                            class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                            {{ formatRupiah($row->sisa_saldo) }}</td>
                                        <td
                                            class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                            {{ $row->keterangan }}</td>
                                        <td
                                        ...
                                        <td class="px-6 py-4 text-sm font-medium whitespace-nowrap text-end">
                                            <div class="inline-block hs-tooltip">
                                                <button type="button" type="button" data-hs-overlay="#edit-modal-warna"
                                                    data-id="{{ $row->id }}"
                                            ...
                                            <div class="inline-block hs-tooltip">
                                                <a href="/operational/pemakaian/{{ $row->id }}"
                                                    class="inline-flex items-center justify-center px-2 py-2 text-sm font-semibold text-gray-800 bg-white border shadow-sm edit-warna hs-tooltip-toggle gap-x-2 hover:bg-gray-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="green"
                                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                                                        class="w-4 h-4 lucide lucide-plus">
                                                        <path d="M5 12h14" />
                                                        <path d="M12 5v14" />
                                                    </svg>
                                                    <span
                                            ...
                                            <div class="inline-block hs-tooltip">
                                                <form action="/operational/delete/{{ $row->id }}" method="post"
    ...
    <div id="modal-tambah"
        ...
        <div
            ...
            <div
                ...
                <form action="/operational/store" method="post">
                    @csrf
                    <div class="p-4 space-y-2 overflow-y-auto">
                        <label for="saldo_awal" class="block mb-2 text-sm font-medium dark:text-white">Saldo Awal</label>
