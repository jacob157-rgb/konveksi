                                    ...
                                    @foreach ($model as $row)
                                        <tr class="text-center">
                                            ...
                                            <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                                                <a href="/model/detail/{{ $row->id }}" 
                                                    class="inline-flex items-center text-sm font-semibold text-green-600 border border-transparent rounded-lg edit gap-x-2 hover:text-green-800  disabled:opacity-50 dark:text-green-500 dark:hover:text-green-400">Detail</a>
                                                <a href="/model/edit/{{ $row->id }}" 
                                                    class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg edit gap-x-2 hover:text-blue-800  disabled:opacity-50 dark:text-blue-500 dark:hover:text-blue-400">Edit</a>
                                                <form action="/model/delete/{{ $row->id }}" method="post"
