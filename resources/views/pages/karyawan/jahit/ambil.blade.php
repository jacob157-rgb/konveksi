...
@section('content')
    <div
        ...
        <h2 class="font-bold text-center text-white uppercase">KARYAWAN {{ $karyawan->nama }}</h2>
    </div>
    <div
                ...
                <form action="/karyawan/jahit/ambil/{{ $karyawan->id }}/store" method="post" id="addBarangJadiForm">
                    ...
                    <div class="inline-block min-w-full py-1.5 align-middle">
                        ...
                        <div class="px-3 py-4 overflow-y-auto model-container">
                            <label for="tanggal_ambil" class="block mb-2 text-sm font-medium dark:text-white">Tanggal
                                Ambil</label>
                            <input type="datetime-local" id="tanggal_ambil" name="tanggal_ambil"
                                                ...
                                                <div class="value-container">
                                                    ...
                                                    <div class="relative">
                                                        <input type="number" id="hs-inline-leading-pricing-select-label"
                                                            name="model[0][warna][0][jumlah_ambil]"
                                                    ...
                                                    <label for="harga"
                                                        class="block mb-2 text-sm font-medium dark:text-white">Ongkos
                                                        Satuan</label>
                                                    <div class="relative rounded-md">
                                                        <input type="text" name="model[0][warna][0][ongkos]"
                                                    ...
                                                    <label for="total"
                                                        class="block mb-2 text-sm font-medium dark:text-white">Estimasi
                                                        Total
                                                        Ongkos</label>
                                                    <div class="relative rounded-md">
        ...
        <div class="grid grid-cols-1 mb-2 space-y-2 md:grid-cols-2 md:space-x-2 md:space-y-0">
            <div>
                            ...
                            <div class="warna-card">
                                <div
                                    ...
                                    <div class="value-container">
                                        ...
                                        <div class="relative">
                                            <input type="number" id="hs-inline-leading-pricing-select-label"
                                                name="model[${modelCount}][warna][${warnaCount}][jumlah_ambil]"
                                        ...
                                        <label for="harga"
                                            class="block mb-2 text-sm font-medium dark:text-white">Ongkos Satuan</label>
                                        <div class="relative rounded-md">
                                            <input type="text" name="model[${modelCount}][warna][${warnaCount}][ongkos]"
                                        ...
                                        <label for="total"
                                            class="block mb-2 text-sm font-medium dark:text-white">Estimasi Total Ongkos</label>
                                        <div class="relative rounded-md">
