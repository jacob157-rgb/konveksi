...
@section('content')
    <div
        class="flex flex-col p-4 overflow-hidden bg-white border border-gray-200 shadow-sm dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 rounded-xl md:p-5">
        <div class="inline-block min-w-full p-1.5 align-middle">
            <div class="border-0 border-gray-200 dark:border-neutral-700 md:flex md:items-center md:justify-between">
                <button type="button"
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td
                                                ...
                                                <a href="/karyawan/cutting/ambil/{{ $row->id }}"
                                                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-full text-nowrap gap-x-2 hover:bg-blue-700 focus:bg-blue-700 focus:outline-none disabled:pointer-events-none disabled:opacity-50">
                                                    Ambil Cutting
                                                ...
                                                <div class="inline-block hs-tooltip">
                                                    <button type="button" data-id="{{ $row->id }}"
                                                        ...
                                                        class="hs-tooltip-toggle edit dark:border-neutral-700 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800 inline-flex items-center justify-center gap-x-2 rounded-s-md bg-white px-1.5 py-1 text-sm font-semibold text-gray-800 shadow-sm hover:bg-gray-50">
                                                        ...
                                                        <span
                                                            class="absolute z-10 invisible inline-block px-4 py-2 font-medium text-white transition-opacity bg-gray-900 rounded shadow-sm opacity-0 hs-tooltip-content dark:bg-neutral-700 hs-tooltip-shown:visible hs-tooltip-shown:opacity-100"
                                                            role="tooltip">
                                                            Edit
                                                        </span>
                                                    </button>
                                                ...
                                                <div class="inline-block hs-tooltip">
                                                    <form action="/karyawan/delete/{{ $row->id }}" method="post"
                                                        ...
                                                        @csrf
                                                        <button type="submit"
                                                            class="hs-tooltip-toggle delete dark:border-neutral-700 dark:bg-neutral-900 dark:text-white dark:hover:bg-neutral-800 inline-flex items-center justify-center gap-x-2 rounded-e-md bg-white px-1.5 py-1 text-sm font-semibold text-gray-800 shadow-sm hover:bg-gray-50">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            ...
                                                            <span
                                                                class="absolute z-10 invisible inline-block px-4 py-2 font-medium text-white transition-opacity bg-gray-900 rounded shadow-sm opacity-0 delete hs-tooltip-content dark:bg-neutral-700 hs-tooltip-shown:visible hs-tooltip-shown:opacity-100"
                                                                role="tooltip">
                                                                Hapus
                                                            </span>
                                                        </button>
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center justify-between px-4 py-3 border-b dark:border-neutral-700">
                        ...
                        <button type="button"
                            class="flex items-center justify-center text-sm font-semibold text-gray-800 border border-transparent rounded-full size-7 dark:text-white dark:hover:bg-neutral-700 hover:bg-gray-100 disabled:pointer-events-none disabled:opacity-50"
                            data-hs-overlay="#tambah-modal">
