...
@section('content')
    <div
        ...
        <h2 class="font-bold text-center text-white uppercase">SUPPLYER {{ $barangMentahFirst->supplyer->nama }}</h2>
    </div>
    <div
            ...
            <div class="-m-1.5 overflow-x-auto">
                <form action="/barang/jadi" method="post" id="addBarangJadiForm">
                    ...
                    <div class="inline-block min-w-full py-1.5 align-middle">
                        ...
                        <input type="text" name="supplyer_id" hidden value="{{ $barangMentahFirst->supplyer->id }}">
                        <div class="px-3 py-4 overflow-y-auto model-container">
                            ...
                            <input type="datetime-local" id="tanggal_kirim" name="tanggal_kirim"
                                ...
                                autofocus="">
                            <!-- Select -->
                            <label for="tanggal_kirim" class="block pt-2 mb-2 text-sm font-medium dark:text-white">Id Barang
                                Mentah</label>
                            <input type="text" id="unique_id" name="unique_id"
                                value="{{ $barangMentahFirst->unique_id }}"
                                class="block w-full px-4 py-3 text-sm border border-gray-200 rounded-lg dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500 focus:border-blue-500 focus:ring-blue-500"
                                autofocus="" disabled>
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            ...
                            window.location.href = "/supplyer/detail/{{ $barangMentahFirst->supplyer->id }}";
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
